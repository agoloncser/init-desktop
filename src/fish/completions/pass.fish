...
# From: https://github.com/tadfisher/pass-otp/pull/151/files#diff-e31f33168f4b148c3eeaa2633f0353de333fcf78b0ff49d47a872bdab41e57b0R47
# modified:
# - add switch to load correctly on macos and linux
# - replace `__fish_pass_print_entries_and_dirs` to `__fish_pass_print_entries`

# Set path of original fish completion correctly
switch (uname)
    case Darwin
        source "/opt/homebrew/share/fish/vendor_completions.d/pass.fish" 2>/dev/null; or source "/usr/local/share/fish/vendor_completions.d/pass.fish"
    case Linux
...
complete -c $PROG -f -n '__fish_pass_uses_command otp append' -a "(__fish_pass_print_entries)"
...
complete -c $PROG -f -n '__fish_pass_uses_command otp uri' -a "(__fish_pass_print_entries)"
